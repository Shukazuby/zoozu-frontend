    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-slate-600">Sign in to continue shopping.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 rounded-xl border border-slate-100 bg-white p-6 shadow-sm">
          ...
          <p className="text-sm text-slate-600 text-center">
            ...
            <Link href={`/auth/signup?next=${encodeURIComponent(next)}`} className="font-semibold text-yellow-700 hover:text-yellow-600">
              Sign up
            </Link>
          </p>
        </form>
