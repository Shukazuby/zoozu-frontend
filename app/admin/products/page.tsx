    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="rounded-lg bg-yellow-600 px-4 py-2 text-sm font-semibold text-slate-900 transition hover:bg-yellow-500"
        >
          + Add Product
        </Link>
      </div>
                ...
                <tr key={product._id} className="hover:bg-slate-50">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="relative h-12 w-12 rounded border border-slate-200 overflow-hidden">
