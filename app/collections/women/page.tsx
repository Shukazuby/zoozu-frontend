...
const categoryOptions = ["All", "Gowns", "Bridal", "Ready-to-Wear", "Suits", "Kaftan", "Accessories"];
    ...
    <div className="bg-white pb-16 pt-12">
      <div className="container space-y-10">
        <div className="text-center space-y-3">
          <p className="text-xs font-semibold uppercase tracking-[0.25em] text-yellow-700">Women&apos;s Collection</p>
          <h1 className="text-4xl font-semibold text-slate-900">Elegant. Modern. Effortless.</h1>
          <p className="text-base text-slate-600 max-w-2xl mx-auto">
            Luxe gowns, power suiting, and bespoke bridal pieces crafted with impeccable tailoring for the modern woman.
          </p>
        </div>

        <div className="flex flex-wrap items-center justify-center gap-3 text-sm font-semibold text-slate-700">
          {["All", "Dress", "Two-Piece", "Ready-to-Wear", "Ankara", "Bou-Bou"].map((item) => {
