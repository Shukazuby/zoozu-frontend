...
const recommendations = [
  ...
  {
    title: "Kaftan Tunic Set",
    price: "₦60,000",
    image:
      "https://images.unsplash.com/photo-1542293787938-4d273c37f3e4?auto=format&fit=crop&w=800&q=80",
  },
  {
    title: "Adire Print Shirt",
    price: "₦45,000",
    image:
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
          <div className="lg:w-[40%] space-y-5">
            <div className="relative h-[560px] w-full overflow-hidden rounded-lg bg-slate-50">
              <Image
                src={gallery[0]}
                alt="The Lagos Edit Senator Set"
                fill
          ...
          <div className="lg:w-[60%] space-y-6">
            <div className="space-y-3">
              <h1 className="text-4xl font-semibold text-slate-900 leading-tight">
                The Lagos Edit Senator Set
              </h1>
              <p className="text-lg font-semibold text-yellow-700">₦85,000</p>
              <p className="max-w-xl text-sm text-slate-700 leading-relaxed">
                Experience refined elegance with “The Lagos Edit Senator Set.”
                Crafted from premium, breathable fabric, this traditional attire
                features intricate, subtle embroidery along the placket and
                cuffs, showcasing a blend of classic Nigerian heritage and
                contemporary design. Perfect for formal events, cultural
                celebrations, or a distinguished everyday look.
              </p>
            </div>
